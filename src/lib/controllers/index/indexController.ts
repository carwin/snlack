// @TODO - We don't actually want to implement a templating system and render visuals.
...
export class IndexController implements Controller {
  ...
  private indexPage(req: Request, res: Response, next: NextFunction) {
    if (req.user) {
      console.log('Wow! the user is AUTHORIZED WITH SNYYYYYK');
    }
    // if (req.user) return res.redirect('/projects');
    // return res.render('index');
    res.end('Welcome to the index friend');
  }
}
