...
import { CmdHandlerFn, SnlackUser, SnykCommandParts, SnykProject } from '../../../types';
...
export const snykProjectDepsCommandHandler: CmdHandlerFn = async(rawCommand, respond, {subcmd, ...params}: SnykCommandParts) => {
